...
SculpinTrawl is used to process benthic trawl data and generate Fig. 5.

Data for this project (raw videos, pose estimation data and model, and sculpin trawl data) can be found at the Environmental Data Initiative: 
